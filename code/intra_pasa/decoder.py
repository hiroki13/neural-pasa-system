...
class Decoder(object):
    ...
    def set_model(self):
        ...
        self.model = Model(x=x, y=y, n_words=n_words, n_vocab=n_vocab, init_emb=init_emb, n_in=n_in, n_h=n_h, n_y=n_y,
                           window=window, unit=unit, opt=opt, lr=lr, dropout=dropout, L2_reg=L2_reg, n_layers=n_layers)
