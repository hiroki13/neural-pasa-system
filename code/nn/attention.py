...
class AttentionLayer(object):
    ...
    def __init__(self, n_h):
        ...
        self.params = [self.W, self.W1_c, self.W1_h, self.w, self.W2_r, self.W2_h]
    ...
    def multi_seq_attention(self, h, n_prds):
        ...
        :return: y: 1D: n_words, 2D: batch_size, 3D: n_h
        """
#        C = h.dimshuffle(1, 0, 2).reshape((h.shape[1] / n_prds, h.shape[0] * n_prds, h.shape[2]))
    ...
    def one_mp_attention(self, h_t, C_t, W1_c, W1_h, w, W2_r, W2_h, eps=1e-8):
        """
        :param h_t: 1D: batch_size, 2D n_h
        :param C_t: 1D: batch_size, 2D: n_prds, 3D n_h
        ...
        alpha = softmax_3d(T.dot(M, w), axis=1, keepdim=True, eps=eps)
    ...
    def one_attention(self, h_t, C, W1_c, W1_h, w, W2_r, W2_h, eps=1e-8):
        """
        :param h_t: 1D: batch_size, 2D n_h
    ...
    def one_ms_attention(self, h_t, C, W1_c, W1_h, w, W2_r, W2_h, eps=1e-8):
        """
        :param h_t: 1D: batch_size, 2D n_h
        ...
        # 1D: batch_size, 2D: n_words * n_prds, 3D: 1
        alpha = softmax_3d(T.dot(M, w), axis=1, keepdim=True, eps=eps)
